...
class Calculator:
    def __init__(self, master):
        ...
        Button(width=11,height=4,text=' (',relief='flat' ,bg= 'cyan' ,command=lambda:self.show('(')).place(x= 0,y=50)
        Button(width=11,height=4,text=' )',relief='flat' ,bg= 'cyan' ,command=lambda:self.show(')')).place(x= 90,y=50)
        Button(width=11,height=4,text=' %',relief='flat' ,bg= 'cyan' ,command=lambda:self.show('%')).place(x=180 ,y=50)
        ...
        Button(width=11,height=4,text='+',relief='flat' ,bg= 'cyan' ,command=lambda:self.show('+')).place(x=270,y=275)
        Button(width=11,height=4,text=' -',relief='flat' ,bg= 'cyan' ,command=lambda:self.show('-')).place(x= 270,y=200)
        Button(width=11,height=4,text=' x',relief='flat' ,bg= 'cyan' ,command=lambda:self.show('*')).place(x= 270,y=50)
        Button(width=11,height=4,text=' /',relief='flat' ,bg= 'cyan' ,command=lambda:self.show('/')).place(x= 270,y=125)
